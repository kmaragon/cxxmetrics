...
template <sortable_template_type... TLeft, sortable_template_type... TRight,
          typename... TTail>
struct static_concat<sortable_template_collection<TLeft...>,
                     sortable_template_collection<TRight...>, TTail...> {
  using type =
      typename static_concat<sortable_template_collection<TLeft..., TRight...>,
                             TTail...>::type;
};
...
template <sortable_template_type TPivot, sortable_template_type THead,
          sortable_template_type... TData>
struct static_partition<sortable_template_collection<TPivot, THead, TData...>> {
private:
  using left_ = typename static_partition<
      sortable_template_collection<TPivot, TData...>>::left;
  using middle_ = typename static_partition<
      sortable_template_collection<TPivot, TData...>>::middle;
  using right_ = typename static_partition<
      sortable_template_collection<TPivot, TData...>>::right;

public:
  using left = typename static_if_else<
      is_less<THead, TPivot>::value,
      typename static_concat<sortable_template_collection<THead>, left_>::type,
      left_>::type;
  using middle = typename static_if_else<
      are_equal<THead, TPivot>::value,
      typename static_concat<sortable_template_collection<THead>,
                             middle_>::type,
      middle_>::type;
  using right = typename static_if_else<
      is_greater<THead, TPivot>::value,
      typename static_concat<sortable_template_collection<THead>, right_>::type,
      right_>::type;
};
...
template <sortable_template_type TFirst, sortable_template_type TSecond,
          sortable_template_type... TTail>
struct static_uniq<sortable_template_collection<TFirst, TSecond, TTail...>> {
  using type = typename static_if_else<
      are_equal<TFirst, TSecond>::value,
      typename static_uniq<
          sortable_template_collection<TFirst, TTail...>>::type,
      typename static_concat<sortable_template_collection<TFirst>,
                             typename static_uniq<sortable_template_collection<
                                 TSecond, TTail...>>::type>::type>::type;
};
